...
public class GcsConfig {
    ...
    public Storage storage() throws IOException {
        ...
        if (bucketName == null || bucketName.isBlank()) {
            throw new IllegalStateException("gcloud.bucket/GCLOUD_BUCKET não pode ser vazio");
        }
        ...
        if (b64 != null) {
            try {
                ...
                log.error("GCLOUD_CREDENTIALS_B64 inválido: {}", e.getMessage());
            ...
            if (json != null && json.startsWith("{")) {
                ...
                log.info("GCS: usando Application Default Credentials (ADC)");
            }
        }
